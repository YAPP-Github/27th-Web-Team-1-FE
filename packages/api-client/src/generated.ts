...
export const getSaveNotificationEmailMutationOptions = <
  TError = void | ApiResponseErrorDetail,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type SaveNotificationEmailMutationResult = NonNullable<
  Awaited<ReturnType<typeof saveNotificationEmail>>
>;
 ...
 * @summary 알림 이메일 저장
 */
export const useSaveNotificationEmail = <
  TError = void | ApiResponseErrorDetail,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export const getSaveNotificationEmailMockHandler = (
  overrideResponse?:
    | void
