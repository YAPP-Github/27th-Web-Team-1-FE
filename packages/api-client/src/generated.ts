...
export const getCreateMutationOptions = <TError = void | ApiResponseErrorDetail,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof create>>, TError,{data: CreateWorkspaceRequest}, TContext>, }
...
export const joinByInviteCode = (
 ...
 signal?: AbortSignal
      ...
      headers: {'Content-Type': 'application/json', },
      data: joinWorkspaceRequest, signal
    },
      );
    }
...
export const getJoinByInviteCodeMutationOptions = <TError = ApiResponseErrorDetail | IdResponse,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof joinByInviteCode>>, TError,{data: JoinWorkspaceRequest}, TContext>, }
): UseMutationOptions<Awaited<ReturnType<typeof joinByInviteCode>>, TError,{data: JoinWorkspaceRequest}, TContext> => {
...
const {mutation: mutationOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof joinByInviteCode>>, {data: JoinWorkspaceRequest}> = (props) => {
          const {data} = props ?? {};
...
export const getCreate1MutationOptions = <TError = ApiResponseErrorDetail | IdResponse,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof create1>>, TError,{data: CreatePhotoRequest}, TContext>, }
): UseMutationOptions<Awaited<ReturnType<typeof create1>>, TError,{data: CreatePhotoRequest}, TContext> => {
...
const {mutation: mutationOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof create1>>, {data: CreatePhotoRequest}> = (props) => {
          const {data} = props ?? {};
...
export const getLoginMutationOptions = <TError = ApiResponseErrorDetail,
 ...
 * @summary 회원가입/로그인
 */
export const useLogin = <TError = ApiResponseErrorDetail,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof login>>, TError,{data: LoginRequest}, TContext>, }
 ): UseMutationResult<
...
export const home = (
 ...
 signal?: AbortSignal
      ...
      return customFetcher<HomeResponse>(
      {url: `/map/home`, method: 'GET',
        params, signal
    },
      );
    }
...
export const getHomeQueryKey = (params?: HomeParams,) => {
    return [
    `/map/home`, ...(params ? [params]: [])
    ] as const;
    }

    
export const getHomeQueryOptions = <TData = Awaited<ReturnType<typeof home>>, TError = ApiResponseErrorDetail>(params: HomeParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof home>>, TError, TData>, }
) => {
...
export function useHome<TData = Awaited<ReturnType<typeof home>>, TError = ApiResponseErrorDetail>(
...
export const getHomeMockHandler = (overrideResponse?: HomeResponse | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<HomeResponse> | HomeResponse), options?: RequestHandlerOptions) => {
  return http.get('*/map/home', async (info) => {await delay(1000);
